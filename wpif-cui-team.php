											 ...
											 <div class="card shadow-sm">
												...
												<div class="card-body p-0">
													<table id="" class="table table-striped table-row-bordered gy-5 gs-7">
														...
														<tbody>
															<tr data-bs-toggle="modal" data-bs-target="#kt_modal_stacked_1">
																<td>Tiger Nixon</td>
																<td>Sept 04, 2025 14:13:10</td>
																<td>0 / 0</td> 
															</tr> 
...
<div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
        <div class="modal-header bg-light-info">
            <h3 class="modal-title">Mudassar Mehdi</h3>
            ...
            <div class="table-responsive">
				<table class="table"> 
					<tbody>
						<tr>
							<td>Name</td>
							<td>Mudassar Mehdi</td> 
						</tr>
						<tr>
							<td>Email</td>
							<td>mudassar@coopcf.com</td> 
						</tr> 
						<tr>
