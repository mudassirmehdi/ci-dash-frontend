								...
								<div class="d-flex align-items-center mb-3">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
										...
										<li class="breadcrumb-item text-gray-700 fw-bold lh-1 mx-n1">
											<a href="{{ route('home') }}" class="text-hover-primary">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-500 mx-n1">{{ ucfirst(Request::segment(1)) }}</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
								<!--begin::Title-->
								<h1 class="text-gray-900 fw-bolder m-0">{{ ucfirst(Request::segment(1)) }}</h1>
								<!--end::Title-->
							</div>
							<!--end::Page title-->
								...
								<div class="">
									...
									<div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
										<div class="d-flex flex-center cursor-pointer symbol symbol-custom symbol-40px">
											<img src="assets/images/qr-code.png" alt="image" />
										</div>
										<!--begin::Username-->
										<div class="d-flex flex-column ms-2">
											<div class="fw-bold d-flex align-items-center fs-5">Robert Parker</div>
											<a href="#" class="fw-semibold text-muted text-hover-primary fs-7">https://coopincome.com/7242/</a>
										</div>
								 ...
								 <!--begin::Menu item-->
										<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
											<a href="#" class="menu-link px-5">
												<span class="menu-title position-relative">Theme 
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="{{ route('profile-overview') }}" class="menu-link px-5">
										...
										<!--begin::Menu item-->
										<div class="menu-item px-5">
											<a href="{{ route('balance') }}" class="menu-link px-5">
