													...
													<div class="row">
														<div class="col-8">
															<div class="welcome-content">
																...
																<div class="w-action">
																	<a href="#" type="button" class="btn btn-info ">Register a Teammate</a>
																</div>
															</div>
														</div>
														<div class="col-4">
											...
											<div class="card card-flush mb-5">
												<div class="card-header"> 
													...
													<div class="slider-actions">
														<!--begin::Slider button-->
														<button class="btn btn-icon btn-active-color-info " id="kt_team_slider_prev1">
														...
														<!--begin::Slider button-->
														<button class="btn btn-icon btn-active-color-info " id="kt_team_slider_next1">
															<span class="svg-icon fs-3x">
											...
											<div class="card card-flush mb-5"> 
												...
												<div class="card-body pt-2">
													<div class="d-flex flex-stack mb-5"> 
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<div class="flex-grow-1 me-2">
																<a href="#" class="text-gray-800 text-hover-info  fs-6 fw-bold">New Referral Bonus Alert!</a>
													...
													<div class="d-flex flex-stack mb-5"> 
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<div class="flex-grow-1 me-2">
																<a href="#" class="text-gray-800 text-hover-info  fs-6 fw-bold">Platform Upgrade Coming</a>
																<span class="text-muted fw-semibold d-block fs-7">Earn 20% extra for every new...</span>
															</div>  
														</div> 
													</div>
													...
													<div class="d-flex flex-stack mb-5"> 
														...
														<div class="d-flex align-items-center flex-row-fluid flex-wrap">
															<div class="flex-grow-1 me-2">
																<a href="#" class="text-gray-800 text-hover-info  fs-6 fw-bold">Team Challenge Week</a>
																<span class="text-muted fw-semibold d-block fs-7">Earn 20% extra for every new...</span>
															</div>  
														</div> 
													</div>
												...
												<div class="card-body pt-2">
													 <!--begin::Item-->
														<div class="d-flex mb-7">
															...
															<!--begin::Title-->
															<div class="m-0">
																<a href="#" class="text-gray-900 fw-bold text-hover-info  fs-6">5 Ways to Boost Your Invite Success Rate</a>
													...
													<!--begin::Item-->
														<div class="d-flex mb-7">
															...
															<!--begin::Title-->
															<div class="m-0">
																<a href="#" class="text-gray-900 fw-bold text-hover-info  fs-6">Top earners manage daily 3 minutes.</a>
																<span class="text-gray-600 fw-semibold d-block pt-1 fs-7">Growth Tips | 3 min read</span>
															</div>
															<!--end::Title-->
														</div>
													...
													<!--begin::Item-->
														<div class="d-flex mb-7">
															...
															<!--begin::Title-->
															<div class="m-0">
																<a href="#" class="text-gray-900 fw-bold text-hover-info  fs-6">The Psychology of a Great Invitation</a>
																<span class="text-gray-600 fw-semibold d-block pt-1 fs-7">Growth Tips | 3 min read</span>
															</div>
															<!--end::Title-->
														</div>
													...
													<a href="#" type="button" class="w-100 btn-sm btn btn-info ">View All</a>
												</div> 
											</div>
										</div>
									</div>
